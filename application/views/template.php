                            ...
                            <div class="nk-sidebar-widget d-none d-xl-block">
                                <div class="user-account-info between-center">
                                    <div class="user-account-main">
                                        ...
                                        <div class="user-balance">124</small></div>
                                ...
                                <ul class="user-account-data gy-1">
                                    <li>
                                        ...
                                        <div class="user-account-value">
                                            <span class="sub-text">23<span class="currency currency-btc"></span></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="user-account-label">
                                        ...
                                        <div class="user-account-value">
                                            <span class="lead-text">223 <span class="currency currency-btc"></span></span>
                                            <span class="text-success ml-2">40% <em class="icon ni ni-arrow-long-up"></em></span>
                                        </div>
                                    </li>
                                </ul>
                                <div class="user-account-actions">
                                    <a href="#" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#modalForm"><span>Laporkan Bencana</span></a>
                                </div>
                ...
                <div class="modal-body">
                    <form action="#" class="form-validate">
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="fv-topics">Jenis Bencana</label>
                                    <div class="form-control-wrap ">
                                        <select class="selectpicker" id="fv-topics" name="fv-topics">
                                            <option>Pilih...</option>
                                            <option data-icon="wi wi-night-sleet">Banjir</option>
                                            <option data-icon="wi wi-meteor" selected>Meteor Jatuh</option>
                                            <option data-icon="wi wi-tornado">Tornado/Beliung</option>
                                            <option data-icon="wi wi-volcano">Gunung Meletus</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <textarea class="form-control form-control-sm" id="fv-message" name="fv-message" placeholder="Tulis laporan lengkap mengenai bencana disini" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="fv-subjectx" name="fv-subjectx" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap ">
                                        <select class="selectpicker" id="fv-topics1" name="fv-topics1">
                                            <option>Pilih...</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="selectpicker" id="fv-topics2" name="fv-topics2">
                                            <option>Pilih...</option>
                                            <option value="bg-primary" class="bg-primary text-white">Biru</option>
                                            <option value="bg-warning" class="bg-warning text-white">Kuning</option>
                                            <option value="bg-danger" class="bg-danger text-white">Merah</option>
                                            <option value="bg-info" class="bg-info text-white">Indigo</option>
                                            <option value="bg-success" class="bg-success text-white">Hijau</option>
                                            <option value="bg-dark" class="bg-dark text-white">Hitam</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
